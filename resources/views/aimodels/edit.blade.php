            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form id="aimodel-form" action="{{ route('aimodels.update', $aimodel->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" placeholder="Study your api to be sure" value="{{ old('name', $aimodel->name) }}">
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="source" id="source" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" placeholder="openai or local" value="{{ old('source', $aimodel->source) }}">
                        @error('source')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
