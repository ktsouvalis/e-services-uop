...
return [
    ...
    // password, so this is username+password auth, not key-based.
    'ssh' => [
    ...
    // MAC/ARP tables don't need per-minute freshness - default to every 10
    // minutes.
    ...
    // `network-lookup:sync-devices` - a git-ignored file rather than an env
    // var, since a ~49-entry JSON blob is painful to hand-edit as a single
    // .env line. Real device topology never gets committed.
